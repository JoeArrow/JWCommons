...
{
    public class JWareEvent : ApplicationException
    {
        ...
        {
            var retVal = true;
            var eLog = new JWareEventLog(EventSource, AppName) { TraceLevel = EventTraceLevel };
